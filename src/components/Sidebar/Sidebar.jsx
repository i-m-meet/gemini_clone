...
const Sidebar = () => {
  ...
  return (
    <div className={`min-h-screen ${isOpen? "w-60" : "w-30"} bg-[#f0f4f9] p-6 flex flex-col justify-between shadow-lg`}>
      ...
      <div className="flex flex-col gap-8">
        ...
        <div className="mt-10 w-full flex items-center justify-center gap-4 py-4 px-4 bg-[#e6eaf1] rounded-3xl text-gray-900 text-md hover:bg-[#d0d8e2] cursor-pointer transition-all duration-300">
          ...
          {isOpen? <p className="font-extralight text-gray-500 hover:text-gray-900 hover:font-semibold">
            New Chat
          </p> : null}
        </div>
        ...
        <div className="flex flex-col gap-2">
          {isOpen? <p className="font-semibold text-gray-700">Recent</p>: null}
